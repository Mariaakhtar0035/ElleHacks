    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card borderColor="border-emerald-500" className="p-6 text-center bounce-in">
            ...
            <p className="text-xs text-gray-500 mt-2">
              That&apos;s {projections.oneMonth - student.growTokens} more tokens!
            </p>
          </Card>

          <Card borderColor="border-blue-500" className="p-6 text-center bounce-in">
            <div className="text-5xl mb-3">🥈</div>
            <h3 className="font-display font-bold text-xl text-gray-900 mb-2">
              In 6 Months
            </h3>
            ...
            <p className="text-xs text-gray-500 mt-2">
              That&apos;s {projections.sixMonths - student.growTokens} more tokens!
            </p>
          </Card>

          <Card borderColor="border-purple-500" className="p-6 text-center bounce-in">
            <div className="text-5xl mb-3">🥇</div>
            <h3 className="font-display font-bold text-xl text-gray-900 mb-2">
              In 1 Year
            </h3>
            ...
            <p className="text-xs text-gray-500 mt-2">
              That&apos;s {projections.oneYear - student.growTokens} more tokens!
            </p>
          </Card>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between mb-2">
                <span className="font-display font-bold text-gray-700">Now</span>
